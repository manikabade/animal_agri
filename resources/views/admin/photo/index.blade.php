        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h3>Photo</h3><br>
                        <a class="btn btn-outline-primary " href="{{route('admin.photo.create')}}" role="button">Create Photo</a>
                    </div>
                    <div class="col-sm-6">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">List of Photo</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                {{--                                <div class="row">--}}
                                    ...
                                    @forelse($photos as $photo)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <img height="100px" width="100px" src="{{asset('images/photo/'.$photo->image)}}">
                                            </td>
                                            <td>
                                                {!! $photo->status ?'<span class="badge badge-success">Active</span>':'<span class="badge badge-danger">InActive</span>' !!}
                                            </td>

                                            <td>
                                                <div class="row">
                                                    <a class="btn btn-success" href="{{route('admin.photo.edit',$photo->id)}}">
...
{{--                                                        </button>--}}
{{--                                                    </form>--}}
                                                    <a href="javascript:void(0)" onclick="var c = confirm('{{ "Are you sure?" }}'); if(c){document.getElementById('delete-{{$photo->id}}').submit();}" class="btn btn-sm swalDefaultQuestion btn-danger">
                                                        <i class="fa fa-trash"></i>
                                                        <form id="delete-{{$photo->id}}" action="{{ route('admin.photo.destroy',$photo->id) }}" method="POST"  style="display: none;">
                                                            @method('DELETE')
                                                            @csrf
                                                        </form>
                                                    </a>
