...
<div class="row">
           <div class="text-white footer-box "> 
              <p class="animation">ANIMAL HUSBANDRY</p>
          </div>
    <div class="container">
            <div class="col-md-4 col-sm-4">
                <div class="footer-thumb">
                    <h4 class="wow fadeInUp" data-wow-delay="0.4s">Agriculture</h4>
                    <div class="latest-stories">
                        ...
                        <div class="stories-info">
                            ...
                            <span>Agri is a organization of animal husbandry</span> -->
                            <p>Agri is a organization of animal husbandry</p>
                        </div>
                    </div>
            ...
            <div class="col-md-4 col-sm-4">
                <div class="footer-thumb">
                    ...
                    <div class="contact-info">
                        ...
                        <p><i class="fa fa-envelope-o"></i> agri.com</p>
                    </div>
                </div>
            </div>
            <div class="col-md-4 col-sm-4">
            ...
            <div class="col-md-12 col-sm-12 border-top">
                <div class="col-md-4 col-sm-6">
                    <div class="copyright-text">
                        <p>Copyright &copy; Agri {{$_site_profile->copyright}}
